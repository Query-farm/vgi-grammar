...
`farm.query:vgi:0.4.0` (pulls `farm.query:vgirpc:0.10.2` transitively; declared
...
with the vgi 0.4.0 record arity (trailing `atUnit`, `atValue`, `storage`
components as `null`); get the exact constructor with

# vgi-grammar VGI worker — build, unit-test, and SQL E2E targets.
#
# Usage:
#   make build      # fat JAR -> build/libs/vgi-grammar-<ver>-all.jar
...
JAR_GLOB       = build/libs/vgi-grammar-*-all.jar
...
test-sql: build
	...
	echo "Worker JAR: $$JAR"; \
	VGI_GRAMMAR_WORKER="java -jar $$(pwd)/$$JAR" \
